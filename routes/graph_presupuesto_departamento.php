...
$sql = "SELECT
          ...
          (proyecto.presupuesto_ejecutor + proyecto.presupuesto_contraparte) AS suma
...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            // Create the chart
            $('#container_graph_presupuesto_departamento').highcharts({
                chart: {
                    type: 'column'
                },
                title: {
                    text: 'Presupuesto departamento'
                },
                xAxis: {
                    type: 'category'
                },
...
<div id="container_graph_presupuesto_departamento" style="min-width: 200px; height: 300px; margin: 0 auto"></div>
</body>
</html>
