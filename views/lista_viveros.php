                ...
                <div class="portlet light portlet-fit portlet-datatable bordered" id="form_wizard_1">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            $path = $BASE_PATH . "/routes/get_lista_viveros.php";
                            ...
                            foreach ($json_a as $person_name => $person_a) {
                                ...
                                ?>
                                <tr class="odd gradeX">
                                    <td><?php echo " " . $person_a['id_vivero']; ?></td>
                                    <td><?php echo " " . $person_a['nombre_financiador']; ?></td>
                                    <td><?php echo " " . $person_a['entidad_ejecutora']; ?></td>
                                    <td><?php echo " " . $person_a['capacidad_productiva']; ?></td>


                                    <td><?php

                                        if ($person_a['tipo_vivero'] == 't') {
                                            echo " " . "Individual";
                                        } else if ($person_a['tipo_vivero'] == 'f') {
                                            echo " " . "Comunitario";
                                        }
                                        ?>
                                    </td>
...
//
                                    ...
                                    <td>
                                        ...
                                        <a href="index.php?controller=reporte_vivero&id=<?php echo $person_a['id_vivero'] ?>"><span
